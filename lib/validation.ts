// username
export const validateUsername = (username: string, min: number, max: number): string | null => {
...
// userid
export const validateUserId = (userid: string, min: number, max: number): string | null => {
